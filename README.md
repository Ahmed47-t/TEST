...
| `ai_analyzer.py` | 🧠 محلّل Gemini + إثراء SCF + بناء قيد اليومية |
| `prompt_builder.py` | 📝 البرومبت الذكي بالسياق الضريبي + SCF |
| `schema.py` | 📋 مخطط JSON للحقول (يشمل scf_account لكل منتج) |
| `scf_accounts.py` | 🏦 **مخطط الحسابات الجزائري SCF 2010 كاملاً (49 حساب)** |
| `templates/index.html` | واجهة عربية RTL أنيقة (6 تبويبات) |
